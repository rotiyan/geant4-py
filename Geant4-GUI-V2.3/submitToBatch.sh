...
#singularity exec -B /cvmfs:/cvmfs -B /hpc:/hpc  /users/rnarayan/Public/geant4-10.7_latest.sif  $1 1 
singularity exec -B /cvmfs:/cvmfs -B /hpc:/hpc  /users/rnarayan/Public/geant4-10.7_10.7.1.sif $1 1 
